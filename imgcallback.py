...
class ImageLogger(Callback):
    def __init__(self,  epoch_interval = 1, num_samples = 1, fname=None,defect_types=None,image_size=((224,224)),model=None,normalization=None,num_channels_in=4):
        super().__init__()
    ...
    def on_validation_epoch_end(
        ...
        probs,batch=ConstrainedSegmentMIL.predice_fruto(self,vistas=vistas)
        probs.detach().cpu() 
        batch.detach().cpu()
